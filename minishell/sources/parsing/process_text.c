...
/*   Updated: 2024/11/29 17:21:30 by zuraw            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minishell.h"

// Obsługa cudzysłowów i pomijanie zawartości w pojedynczych cudzysłowach
...
// Oblicza łączną długość VAR'ów -> $PATH = 5
...
// Oblicza łączną długość wszystkich $VAR -> tego co się kryje pod nimi
...
void	process_text(t_token *token)
{
	...
	quot_mark = 0;
	if (token->token == BUILTIN || token->token == OPERATOR)
